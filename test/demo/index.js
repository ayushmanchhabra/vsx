      ...
      return (
        e !== null &&
          Object.entries(e).forEach(([s, a]) => {
            if (
              (s.startsWith("on") &&
                s.toLowerCase() in window &&
                o.addEventListener(s.toLowerCase().substring(2), a),
              s === "style")
            ) {
              let r = "";
              for (let i in a)
...
`;
              o.setAttribute(s, r);
            } else o.setAttribute(s, a.toString());
          }),
        n.forEach((s) => l(o, s)),
        o
      );
...
var p = (t, ...e) => e;
var c = p;
var L = { createElement: d, createFragment: c };
...
var Counter = () => {
  ...
  return /* @__PURE__ */ src_default.createElement(
    src_default.createFragment,
    null,
    /* @__PURE__ */ src_default.createElement(
      "button",
      {
...
document
  .getElementById("root")
  ?.appendChild(/* @__PURE__ */ L.createElement(Counter_default, null));
